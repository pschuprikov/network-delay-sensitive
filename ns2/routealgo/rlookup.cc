...
void RLookup::Log(std::ostream& os)
{
  os << "LOG called";
}

void RLookup::Populate(std::istream& )
{
...
void NOLookup::Log( std::ostream& os)
{
  os << " " << (int)WhatType();
}
...
void FRLookup::Log(std::ostream& os)
{
  os << " " << (int)WhatType();
  os << " " << Default();
}
...
void BMLookup::Log( std::ostream& os)
{
RoutingVec_it i;
...
void HMLookup::Log( std::ostream& os)
{
RouteMap_it i;
...
void NHLookup::Populate(std::istream& is)
...
void NHLookup::Log( std::ostream& os)
{
RoutingVec_it i;
